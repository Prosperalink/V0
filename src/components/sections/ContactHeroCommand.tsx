...
export default function ContactHeroCommand() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center text-cream-white px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          ...
          >
            Ready to embark on your digital journey? Connect with our cosmic
            team and let's create something extraordinary together.
          </motion.p>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-text-subtle">Email Us</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-golden-accent mb-2">
                +216 XX XXX XXX
              </div>
              <div className="text-text-subtle">Call Us</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-golden-accent mb-2">
                Den Den, Tunisia
              </div>
              <div className="text-text-subtle">Visit Us</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
